...
| 47 | **Non-statin LDL-lowering agents / bile acid sequestrants** — ezetimibe, bempedoic acid, cholestyramine, colestipol, colesevelam | 5 entries (19 synonyms, 8 Thai); 18 inserted / 1 skipped. `Ezetimibe` already existed and was upgraded with Thai synonyms. Included hydrochloride/resin forms as parent synonyms where standard. Excluded `cholestyramine chloride`; deferred `colestimide`; excluded `colextran`. |
| 46 | **PCSK9-targeted LDL-lowering agents** — alirocumab, evolocumab, inclisiran | 3 entries (7 synonyms, 3 Thai); 7 inserted / 0 skipped. Included approved agents only; `inclisiran sodium` merged to parent `inclisiran`. Deferred `lerodalcibep-liga` (too new, 0 local hits) and excluded `bococizumab` (development discontinued). |
| 45 | **Branched-Chain Amino Acids (BCAA blend)** — leucine + isoleucine + valine collective entry | 1 entry (10 synonyms, 4 Thai); 10 inserted / 0 skipped. Seeded as its own blend entry, separate from individual leucine/isoleucine/valine and separate from the broader EAA blend. Excluded component triplets + EAA terms to avoid false matches. |
| 44 | **Fibrates (PPAR-α agonists)** — bezafibrate, ciprofibrate, clofibrate, fenofibrate, gemfibrozil, pemafibrate | 6 entries (21 synonyms, 10 Thai); 19 inserted / 2 skipped. Fenofibrate + gemfibrozil existed from batch 1-16; updated with Thai names + choline/fenofibric acid/micronized forms. Clofibrate included (not formally withdrawn). Excluded: etofibrate, simfibrate, ronifibrate, clofibride (niche/discontinued). |
| 43 | **Statins (HMG-CoA reductase inhibitors)** — atorvastatin, fluvastatin, lovastatin, pitavastatin, pravastatin, rosuvastatin, simvastatin | 7 entries (23 synonyms, 11 Thai); 17 inserted / 6 skipped. 5 existing (from batch 1-16) updated with Thai names + salt forms. 2 new: fluvastatin + lovastatin. **Cerivastatin EXCLUDED** — withdrawn globally 2001 (fatal rhabdomyolysis); flag any product match for audit. |
| 42 | **ยาหอมเทพจิตร (Ya Hom Thep Chit — Thai aromatic compound formula)** | 1 (8 synonyms, 5 Thai) — exact formula name + spelling variants ONLY. Excluded: component herbs (กลุ่มโกฐ/เทียน/ดอกมะลิ/การบูร), bioactives (eugenol/borneol), ยาหอม alone (too generic), ยาผง/ยาเม็ด (dosage-form false-match). Related formulas deferred: ยาหอมนวโกฐ, ยาหอมทิพโอสถ, ยาหอมอินทจักร์, ยาหอมแก้ลมวิงเวียน, ยาหอมจันทจักร. All 8 new. |
| 41 | **ไซเลียมฮัสก์ / Psyllium husk / Ispaghula (Plantago ovata)** | 1 (18 synonyms, 8 Thai) — psyllium = ispaghula → ONE entry (both from Plantago ovata). 14 inserted, 4 skipped (core terms already in DB from prior batches). Both ไซเลียม/ไซเลี่ยม and อิสพากูลา/อิสปากูลา spelling variants included. |
